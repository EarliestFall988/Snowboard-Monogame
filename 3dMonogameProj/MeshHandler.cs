...
namespace Core
{
    ...
    /*
     * Grabbed a snippet of this code from the mesh data extractor (in bepuphysics) and modified it to work with this game
     */

    /// <summary>
    /// Creates collidable meshes from models.
    /// </summary>
    public class MeshHandler
    {
        ...
        public static void GetVerticesAndIndicesFromModel(Model collisionModel, out Vector3[] vertices, out int[] indices)
        {
            ...
            {
                throw new ArgumentNullException("collisionModel", "Cannot create a mesh shape from a null model.");
            }
